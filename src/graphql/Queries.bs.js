...
var ppx_printed_query = "query GetTalk($id: ID!)  {\ngetTalk(id: $id)  {\nid  \nname  \nspeakerName  \nspeakerBio  \ntime  \nlocation  \nsummary  \ntwitter  \ngithub  \ncomments  {\nitems  {\nid  \ntalkId  \nmessage  \ncreatedAt  \ndeviceId  \n}\n\nnextToken  \n}\n\n}\n\n}\n";

function parse(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "getTalk");
  var tmp;
  if (match !== undefined) {
...
var ppx_printed_query$1 = "query ListTalks  {\nlistTalks(limit: 500)  {\nitems  {\nid  \nname  \nspeakerName  \nspeakerBio  \ntime  \nspeakerAvatar  \nlocation  \nsummary  \ntimeStamp  \ndate  \ntwitter  \ngithub  \n}\n\nnextToken  \n}\n\n}\n";

function parse$1(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "listTalks");
  var tmp;
  if (match !== undefined) {
    var value$2 = Caml_option.valFromOption(match);
    var match$1 = Js_json.decodeNull(value$2);
        ...
        tmp$1 = match$3 !== undefined ? undefined : Js_option.getExn(Js_json.decodeArray(value$4)).map((function (value) {
                  ...
                  if (match !== undefined) {
                    ...
                    if (match$1 !== undefined) {
                      ...
                      tmp = Js_exn.raiseError("graphql_ppx: Field id on type Talk is missing");
                    }
                    ...
                    if (match$3 !== undefined) {
                      ...
                      tmp$1 = Js_exn.raiseError("graphql_ppx: Field name on type Talk is missing");
                    }
                    var match$5 = Js_dict.get(value$1, "speakerName");
                    var tmp$2;
                    if (match$5 !== undefined) {
                      ...
                      tmp$2 = Js_exn.raiseError("graphql_ppx: Field speakerName on type Talk is missing");
                    }
                    var match$7 = Js_dict.get(value$1, "speakerBio");
                    var tmp$3;
                    if (match$7 !== undefined) {
                      ...
                      tmp$3 = Js_exn.raiseError("graphql_ppx: Field speakerBio on type Talk is missing");
                    }
                    var match$9 = Js_dict.get(value$1, "time");
                    var tmp$4;
                    if (match$9 !== undefined) {
                    ...
                    var match$12 = Js_dict.get(value$1, "speakerAvatar");
                    var tmp$5;
                    if (match$12 !== undefined) {
                    ...
                    var match$15 = Js_dict.get(value$1, "location");
                    var tmp$6;
                    ...
                    var match$18 = Js_dict.get(value$1, "summary");
                    var tmp$7;
                    if (match$18 !== undefined) {
                      var value$9 = Caml_option.valFromOption(match$18);
                      var match$19 = Js_json.decodeString(value$9);
                      tmp$7 = match$19 !== undefined ? match$19 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$9));
                    } else {
                      tmp$7 = Js_exn.raiseError("graphql_ppx: Field summary on type Talk is missing");
                    }
                    var match$20 = Js_dict.get(value$1, "timeStamp");
                    var tmp$8;
                    if (match$20 !== undefined) {
                      ...
                      if (match$21 !== undefined) {
                        ...
                        tmp$8 = match$22 !== undefined ? match$22 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$10));
                      }
                    } else {
                      tmp$8 = undefined;
                    }
                    var match$23 = Js_dict.get(value$1, "date");
                    var tmp$9;
                    if (match$23 !== undefined) {
                      var value$11 = Caml_option.valFromOption(match$23);
                      var match$24 = Js_json.decodeNull(value$11);
                      if (match$24 !== undefined) {
                        tmp$9 = undefined;
                      } else {
                        var match$25 = Js_json.decodeString(value$11);
                        tmp$9 = match$25 !== undefined ? match$25 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$11));
                      }
                    } else {
                      tmp$9 = undefined;
                    }
                    var match$26 = Js_dict.get(value$1, "twitter");
                    var tmp$10;
                    if (match$26 !== undefined) {
                      var value$12 = Caml_option.valFromOption(match$26);
                      var match$27 = Js_json.decodeNull(value$12);
                      if (match$27 !== undefined) {
                        tmp$10 = undefined;
                      } else {
                        var match$28 = Js_json.decodeString(value$12);
                        tmp$10 = match$28 !== undefined ? match$28 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$12));
                      }
                    } else {
                      tmp$10 = undefined;
                    }
                    var match$29 = Js_dict.get(value$1, "github");
                    var tmp$11;
                    if (match$29 !== undefined) {
                      var value$13 = Caml_option.valFromOption(match$29);
                      var match$30 = Js_json.decodeNull(value$13);
                      if (match$30 !== undefined) {
                        tmp$11 = undefined;
                      } else {
                        var match$31 = Js_json.decodeString(value$13);
                        tmp$11 = match$31 !== undefined ? match$31 : Js_exn.raiseError("graphql_ppx: Expected string, got " + JSON.stringify(value$13));
                      }
                    } else {
                      tmp$11 = undefined;
                    }
...
var ppx_printed_query$2 = "query GetComment($id: ID!)  {\ngetComment(id: $id)  {\nid  \ntalkId  \ntalk  {\nid  \nname  \nspeakerName  \nspeakerBio  \ntime  \nlocation  \nsummary  \ntwitter  \ngithub  \ncomments  {\nnextToken  \n}\n\n}\n\nmessage  \ncreatedAt  \ndeviceId  \n}\n\n}\n";

function parse$2(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "getComment");
  var tmp;
  if (match !== undefined) {
    var value$2 = Caml_option.valFromOption(match);
    var match$1 = Js_json.decodeNull(value$2);
...
var ppx_printed_query$3 = "query GetComment($id: ID!)  {\ngetComment(id: $id)  {\nid  \ntalkId  \ntalk  {\nid  \nname  \nspeakerName  \nspeakerBio  \ntime  \nlocation  \nsummary  \ntwitter  \ngithub  \ncomments  {\nnextToken  \n}\n\n}\n\nmessage  \ncreatedAt  \ndeviceId  \n}\n\n}\n";
...
var ppx_printed_query$4 = "query listCommentsByTalkId($talkId: ID!)  {\nlistCommentsByTalkId(talkId: $talkId)  {\nitems  {\nmessage  \ncreatedAt  \ncreatedBy  \n}\n\n}\n\n}\n";

function parse$4(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "listCommentsByTalkId");
  var tmp;
  if (match !== undefined) {
    var value$2 = Caml_option.valFromOption(match);
    var match$1 = Js_json.decodeNull(value$2);
      ...
      if (match$2 !== undefined) {
        ...
        tmp$1 = match$3 !== undefined ? undefined : Js_option.getExn(Js_json.decodeArray(value$4)).map((function (value) {
                  ...
                  if (match !== undefined) {
                    ...
                    var match$7 = Js_dict.get(value$1, "createdBy");
                    var tmp$2;
                    if (match$7 !== undefined) {
  ...
  return {
          listCommentsByTalkId: tmp
        };
}

function make$4(talkId, param) {
  return {
...
function makeVariables$4(talkId, param) {
  return Js_dict.fromArray(/* array */[/* tuple */[
                  "talkId",
                  talkId
                ]].filter((function (param) {
...
function definition_002$4(graphql_ppx_use_json_variables_fn, talkId, param) {
  return Curry._1(graphql_ppx_use_json_variables_fn, Js_dict.fromArray(/* array */[/* tuple */[
                      "talkId",
                      talkId
                    ]].filter((function (param) {
...
var ppx_printed_query$5 = "query ListReports($filter: ModelReportFilterInput, $limit: Int, $nextToken: String)  {\nlistReports(filter: $filter, limit: $limit, nextToken: $nextToken)  {\nitems  {\nid  \ncommentId  \ncomment  \ntalkTitle  \ndeviceId  \n}\n\nnextToken  \n}\n\n}\n";

function parse$5(value) {
  var value$1 = Js_option.getExn(Js_json.decodeObject(value));
  var match = Js_dict.get(value$1, "listReports");
  var tmp;
  if (match !== undefined) {
    var value$2 = Caml_option.valFromOption(match);
    var match$1 = Js_json.decodeNull(value$2);
        ...
        tmp$1 = match$3 !== undefined ? undefined : Js_option.getExn(Js_json.decodeArray(value$4)).map((function (value) {
                  ...
                  if (match !== undefined) {
                    ...
                    if (match$1 !== undefined) {
                      ...
                      tmp = Js_exn.raiseError("graphql_ppx: Field id on type Report is missing");
                    }
                    var match$3 = Js_dict.get(value$1, "commentId");
                    var tmp$1;
                    if (match$3 !== undefined) {
                      var value$3 = Caml_option.valFromOption(match$3);
                      var match$4 = Js_json.decodeString(value$3);
                      ...
                      tmp$1 = Js_exn.raiseError("graphql_ppx: Field commentId on type Report is missing");
                    }
                    var match$5 = Js_dict.get(value$1, "comment");
                    var tmp$2;
                    if (match$5 !== undefined) {
                      var value$4 = Caml_option.valFromOption(match$5);
                      var match$6 = Js_json.decodeString(value$4);
                      ...
                      tmp$2 = Js_exn.raiseError("graphql_ppx: Field comment on type Report is missing");
                    }
                    var match$7 = Js_dict.get(value$1, "talkTitle");
                    var tmp$3;
                    if (match$7 !== undefined) {
                      var value$5 = Caml_option.valFromOption(match$7);
                      var match$8 = Js_json.decodeString(value$5);
                      ...
                      tmp$3 = Js_exn.raiseError("graphql_ppx: Field talkTitle on type Report is missing");
                    }
                    var match$9 = Js_dict.get(value$1, "deviceId");
                    var tmp$4;
                    if (match$9 !== undefined) {
                      var value$6 = Caml_option.valFromOption(match$9);
                      var match$10 = Js_json.decodeNull(value$6);
...
function json_of_ModelReportFilterInput(value) {
  var v = value.id;
  var v$1 = value.commentId;
  var v$2 = value.comment;
  var v$3 = value.talkTitle;
  var v$4 = value.deviceId;
  var v$5 = value.and;
  var tmp;
  if (v$5 !== undefined) {
    var v$6 = v$5;
    tmp = v$6.map((function (v) {
            if (v !== undefined) {
              return json_of_ModelReportFilterInput(Caml_option.valFromOption(v));
            } else {
              return null;
            }
          }));
  ...
  return Js_dict.fromArray(/* array */[
                ...
                /* tuple */[
                  "commentId",
                  v$1 !== undefined ? json_of_ModelIDFilterInput(Caml_option.valFromOption(v$1)) : null
                ],
                /* tuple */[
                  "comment",
                ...
                /* tuple */[
                  "talkTitle",
                  v$3 !== undefined ? json_of_ModelStringFilterInput(Caml_option.valFromOption(v$3)) : null
                ],
                /* tuple */[
                  "deviceId",
                  v$4 !== undefined ? json_of_ModelIDFilterInput(Caml_option.valFromOption(v$4)) : null
                ],
                /* tuple */[
                  "and",
                  tmp
                ...
                /* tuple */[
                  "not",
                  v$9 !== undefined ? json_of_ModelReportFilterInput(Caml_option.valFromOption(v$9)) : null
                ]
              ].filter((function (param) {
                    return !Js_json.test(param[1], /* Null */5);
                  })));
...
function make$5(filter, limit, nextToken, param) {
  return {
          query: ppx_printed_query$5,
          variables: Js_dict.fromArray(/* array */[
                  /* tuple */[
                    "filter",
                    filter !== undefined ? json_of_ModelReportFilterInput(Caml_option.valFromOption(filter)) : null
                  ],
                  /* tuple */[
                    "limit",
...
function makeVariables$5(filter, limit, nextToken, param) {
  return Js_dict.fromArray(/* array */[
                /* tuple */[
                  "filter",
                  filter !== undefined ? json_of_ModelReportFilterInput(Caml_option.valFromOption(filter)) : null
...
function definition_002$5(graphql_ppx_use_json_variables_fn, filter, limit, nextToken, param) {
...
var ListReportsQuery = {
  ...
  json_of_ModelReportFilterInput: json_of_ModelReportFilterInput,
  make: make$5,
