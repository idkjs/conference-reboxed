...
var make = AwsAmplifyReactNative.withAuthenticator(Main.TabNavWithProps.make, AmplifyTheme.theme);
...
function loadResourcesAsync(param) {
  Promise.resolve(Font$Expo.loadAsync(/* :: */[
            /* tuple */[
              "Gotham Rounded",
  ...
  if (match$1) {
    return React.createElement(Expo.AppLoading, {
                startAsync: (function (param) {
                    return Promise.resolve(loadResourcesAsync(/* () */0));
                  }),
