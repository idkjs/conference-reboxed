...
```bash
➜  reboxed [expo*]aws appsync get-graphql-api --api-id 7jnhzcoaqjavjff3fx6d2a5uui
{
    "graphqlApi": {
        "name": "rnconfinabox-dev",
        "authenticationType": "AMAZON_COGNITO_USER_POOLS",
        "apiId": "7jnhzcoaqjavjff3fx6d2a5uui",
        "uris": {
            "GRAPHQL": "https://<your-api-id>.appsync-api.eu-west-1.amazonaws.com/graphql",
            "REALTIME": "wss://<your-api-id>.appsync-realtime-api.eu-west-1.amazonaws.com/graphql"
        },
        "arn": "arn:aws:appsync:eu-west-1:0numbers:apis/7jnhzsomapid2a5uui",
        "userPoolConfig": {
            "defaultAction": "ALLOW",
            "awsRegion": "eu-west-1",
            "userPoolId": "eu-west-1_CmVZdSZFo"
        }
    }
}
```
...
Run: `yarn add @aws-amplify/core @aws-amplify/api @aws-amplify/pubsub`